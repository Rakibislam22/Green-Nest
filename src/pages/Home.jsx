        ...
        <div>
            ...
            <div className='bg-green-50/25'>
                <div className='max-w-7xl mx-auto p-3'>
                    <h1 className='text-5xl text-primary text-center font-medium pt-30'>Our Top Rated Indoor Plants</h1>
                    <div className='grid lg:grid-cols-3 grid-cols-1 gap-5 pt-18'>
                        {
